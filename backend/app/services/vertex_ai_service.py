...
class VertexAIService:
    ...
    def _ensure_model(self):
        ...
        if not self.model:
            proj = settings.google_cloud_project
            loc = settings.vertex_ai_location or settings.google_cloud_region or "us-central1"
            model_name = settings.vertex_ai_model
            
            logger.info(f"Initializing Vertex AI: project={proj}, location={loc}, model={model_name}")
